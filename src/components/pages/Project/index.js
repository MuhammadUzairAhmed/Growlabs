  ...
  constructor(props) {
    ...
    this.state = {
      project: [
        ...
        {
          "id": "2",
          "url": "/calibration_agreements?id=2",
          "name": "DesktopWeb",
          "agency": "Cloud",
          "status": "process",
          "event": "live",
        ...
        <section>
          ...
          {this.state.project.map((items, index) =>
            ...
            <div className="Addproject_box active">
              ...
              <div className="project_plussec" onClick={document.getElementById('projectbutton_{items.id}')}>
              ...
              <Link to={items.url} id={'projectbutton_'+items.id} style={{display: 'none'}}></Link>
            </div>
          )}
