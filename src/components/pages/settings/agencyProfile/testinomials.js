        ...
        <div className="Settings_profiles">
          ...
          <div className="manage_test">
            ...
            <div class="manage_pagenation">
              ...
              {this.state.paginationmanageTestinomial.map(item => <div class="pagenation_number" key={item} onClick={() => this.changePage(item, 'manageTestinomial')} style={{ background: `${this.state.itemIdMTS != item ? '#979797' : '#fff'}` }}>{item}</div>)}
