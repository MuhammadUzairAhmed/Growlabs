...
class Contact extends Component {
    ...
    handleInput =(x)=>
    {
     ...
     console.log('filesUploaded ',this.state.fileUploaded)
    }
    
     render(){
         const listItems = this.state.fileUploaded.map((files) =>
         <li>{files.acceptedFile} <br/><span>{files.size}</span></li>
       );
         return (
                             ...
                             <div class="row">
                                 ...
                                 <div class="form-row full">
                                     <div class="radioList">
                                         ...
                                         <label class="box-label">
                                             <span class="getLocation"><CurrentLocation /></span>
