        ...
        <div className="agreements_form">
          <div className="agreements_flt">
            ...
            <div className="input_box">
              <input type="text" name="x1" placeholder="€0" value={this.state.x1} onChange={this.handleChange1} />
            ...
            <h4>BONUS AMOUNT FOR ACHIEVING DEADLINE</h4>
            <div className="input_box">
              <input type="text" name="x2" placeholder="Minimally 10 days before start new milestone" value={this.state.x2} onChange={this.handleChange2} />
            ...
            <div className="input_box">
              <input type="text" name="x3" placeholder="Monday" value={this.state.x3} onChange={this.handleChange3} />
              <span style={{ color: 'red' }}>{this.state.x3Err}</span>
              <div class="tooltip"><img src="./assets/img/1024px-Infobox_info_icon.svg Copy 4.png" class="" /><span class="tooltiptext">Tooltip text</span></div>
            </div>
            <h4>SPRINTS CALLS</h4>
            <div className="input_box hlf">
              <input type="text" name="x4" placeholder="WED, Fri" value={this.state.x4} onChange={this.handleChange4} />
              <span style={{ color: 'red' }}>{this.state.x4Err}</span>
            </div>
            <div className="input_box hlf rgt">
              <input type="text" name="x5" placeholder="9:00 AM (EPT)" value={this.state.x5} onChange={this.handleChange5} />
              <span style={{ color: 'red' }}>{this.state.x5Err}</span>
            </div>
            <div className="clearfix"></div>
            <h4>MEDIUM</h4>
            <div className="input_box">
              <input type="text" name="x6" placeholder="Skype" value={this.state.x6} onChange={this.handleChange6} />
          ...
          <div className="agreements_rht">
            ...
            <h4>SPRINTS START ON</h4>
            <div className="input_box">
              <input type="text" name="x7" placeholder="Monday" value={this.state.x7} onChange={this.handleChange7} />
              <span style={{ color: 'red' }}>{this.state.x7Err}</span>
              <div class="tooltip"><img src="./assets/img/1024px-Infobox_info_icon.svg Copy 4.png" class="" /><span class="tooltiptext">Tooltip text</span></div>
            </div>
            <h4>WILL USE GROW LABS MANAGMENT TOOL</h4>
            <div className="input_box">
              <input type="text" name="x8" placeholder="Yes" value={this.state.x8} onChange={this.handleChange8} />
              <span style={{ color: 'red' }}>{this.state.x8Err}</span>
              <div class="tooltip"><img src="./assets/img/1024px-Infobox_info_icon.svg Copy 4.png" class="" /><span class="tooltiptext">Tooltip text</span></div>
            </div>
            <h4>WILL USE GROW LABS COMMUNICATION TOOL</h4>
            <div className="input_box">
              <input type="text" name="x9" placeholder="Yes" value={this.state.x9} onChange={this.handleChange9} />
            ...
            <div className="input_box">
              <input type="text" name="x10" placeholder="3 Days in Advance" value={this.state.x10} onChange={this.handleChange10} />
              <span style={{ color: 'red' }}>{this.state.x10Err}</span>
              <div class="tooltip"><img src="./assets/img/1024px-Infobox_info_icon.svg Copy 4.png" class="" /><span class="tooltiptext">Tooltip text</span></div>
            </div>
            <h4>ALWAYS FILL IN FINAL MILESTONE DESCRIPTION IN ADVANCE </h4>
            <div className="input_box">
              <input type="text" name="x11" placeholder="1 Sprint in advance" value={this.state.x11} onChange={this.handleChange11} />
              <span style={{ color: 'red' }}>{this.state.x11Err}</span>
              <div class="tooltip"><img src="./assets/img/1024px-Infobox_info_icon.svg Copy 4.png" class="" /><span class="tooltiptext">Tooltip text</span></div>
            </div>
            <h4>ALWAYS FILL IN FINAL MILESTONE DESCRIPTION IN ADVANCE </h4>
            <div className="input_box">
              <input type="text" name="x12" placeholder="1 Sprint in advance" value={this.state.x12} onChange={this.handleChange12} />
            ...
            <h4>STORY POINTS </h4>
            <div className="input_box">
              <input type="text" name="x13" placeholder="Yes" value={this.state.x13} onChange={this.handleChange13} />
