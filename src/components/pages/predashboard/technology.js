  ...
  render() {
    ...
    return (
      <section className={this.state.technology != '' && this.state.framework != '' && this.state.x3 != '' ? "technology animations-disable" : "technology animations-check"}>
        ...
        <Link to="/calibration_timeframe" className="button" style={{background: `#19D192`}}>Accept Agreement<br/><span> Accept setup as the grounds on which to finalize partnership</span></Link>
      </section>
    );
  };
};
