...
class Description extends Component {
  ...
  componentDidMount() {
    ...
    if (this.props.mileStonedata && this.props.mileStonedata.data != null) {
      this.setState({miledata: this.props.mileStonedata.data})
    }
  }
    ...
    return (
      <section className={this.state.actDiv ? "descriptions animations-disable" : "descriptions animations-check"}>
        ...
        <div className="descriptions_product">
          ...
          <a href="" className="button"> {this.props.mileStonedata ? this.props.mileStonedata.weeks : 'No'} Milestones </a>
          ...
          {this.state.sprintId && this.state.miledata ? this.state.miledata.map((item) => {
            ...
            return this.state.sprintId == item.userd ? <div>
                ...
                <div className={`descriptions_milestone_center ${this.state.activeSEC}`}>
                  ...
                  <a href="" className="button"> {item.input1} SPRINTS </a>
                </div>
        ...
        <Link to="/calibration_contacts" className="buttons" style={{background: `#19D192`}}>Accept Agreement<br/><span> Accept setup as the grounds on which to finalize partnership</span></Link>
      </section>
    );
  };
};
